...
var PathComposer = class {
  ...
  static appendSearchAndHash(pathname, query, hash) {
...
var UrlStateProjector = class {
  ...
  compile(schema) {
    ...
    const bindings = Object.entries(schema).map(
      ([schemaKey, binding]) => new QueryBinding(schemaKey, binding)
    );
...
var HsmMachine = class {
  ...
  href(stateId, params = {}, options = {}) {
    ...
    const hrefOptions = {};
    if (query !== void 0) Object.assign(hrefOptions, { query });
...
export { HsmSchemaError, HsmSchemaFunctionError, HsmSchemaParseError, HsmSchemaValidationError, SchemaCompiler, SchemaConfigFactory, SchemaSerializer, SchemaValidator, assertValidSchema, compileSchema, createHsmFromSchema, defineHsm, schemaFromJson, schemaToJson, validateSchema };
