...
var RequestResolver = class {
  ...
  composePathAndQuery(pathname, query) {
...
export { BackendGuardRegistry, BackendPolicyEnforcer, HsmBackendRuntime, RequestResolver, createHsmBackend, fromNodeRequest, hsmExpressMiddleware, requireHsmCapability, requireHsmFeature, requireHsmPermission, requireHsmState, requireHsmTag };
